...
- `/docs-specs`: 
  - Generate proper specifications for requirements extrated from a Word document and translate them into proper GitHub workable issues.
